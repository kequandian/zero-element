...
function createModel(_ref) {
  ...
  (0, _iostore.createStore)(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _defaultState["default"]), state), _defaultEffects["default"]), effects), {}, {
    namespace: namespace,
    _auto: auto,
