  ...
  (0, _createClass2["default"])(Model, [{
    ...
    value: function setState(key, data) {
      if (typeof key === 'string') {
        this.state[key] = (0, _objectSpread2["default"])({}, this.state[key] || {}, data);
      } else {
        this.state = (0, _objectSpread2["default"])({}, this.getState(), key);
      }
    }
  }, {
    key: "getModel",
    ...
    value: function dispatch(data) {
      ...
      if (this.reducers[type]) {
        var _action = this.reducers[type];

        var rst = _action(data, {
          state: this.getState()
        });
        ...
        this.queue.forEach(function (item) {
          return item.setState(_this2.state);
        });
        return;
      } // effects
      else if (this.effects[type]) {
          var _action2 = function _action2() {
