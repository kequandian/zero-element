...
function _fetchList() {
  _fetchList = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(_ref) {
    var API, payload, extraData, _ref$dataPath, dataPath, fAPI, _yield$query, result, records, data;
          ...
          case 5:
            ...
            if (result && result.code === 200) {
              ...
              if (Array.isArray(result.data)) {
                ...
                data = result.data;
                this[dataPath] = _objectSpread(_objectSpread({}, data), {}, {
...
function _fetchOne() {
  _fetchOne = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(_ref3) {
    var API, payload, extraData, fAPI, _yield$query2, result;
