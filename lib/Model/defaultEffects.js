      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            ...
            return put({
              type: 'save',
              payload: (0, _defineProperty2["default"])({}, MODELPATH, _objectSpread({}, data, {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            return put({
              type: 'save',
              payload: (0, _defineProperty2["default"])({}, MODELPATH, _objectSpread({}, result.data))
            });
...
function _createForm() {
  ...
  _regenerator["default"].mark(function _callee4(_ref6, _ref7) {
    var API, payload, options, put, _ref13, result;

    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            API = _ref6.API, payload = _ref6.payload, options = _ref6.options;
            put = _ref7.put;
            console.log("createForm to :", API); // 如果是下载的 response, 那就使用默认值 { data: {code: 200} }

            _context4.next = 5;
            return (0, _request.post)(API, payload, options);
...
function _updateForm() {
  ...
  _regenerator["default"].mark(function _callee5(_ref8, _ref9) {
    var API, payload, options, put, _ref14, result;

    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            API = _ref8.API, payload = _ref8.payload, options = _ref8.options;
            put = _ref9.put;
            console.log("updateForm to :", API); // 如果是下载的 response, 那就使用默认值 { data: {code: 200} }

            _context5.next = 5;
            return (0, _request.update)(API, payload, options);
