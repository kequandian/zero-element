      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", _axios["default"].post(api, data, _objectSpread({
              baseURL: canEndPoint(api),
              headers: {
                'Authorization': "Bearer " + (0, _token.getToken)()
              }
...
function _remove() {
  _remove = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(api) {
...
function _upload() {
  _upload = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(api, data) {
    var bodyData;
