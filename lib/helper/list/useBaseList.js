  ...
  function onGetList(_ref2) {
    ...
    return (0, _PromiseGen.PromiseAPI)(api, function () {
      ...
      return dispatch({
        ...
        MODELPATH: modelPath,
        DIRECTRETURN: false,
        payload: _objectSpread({}, qD, {}, queryData, (_objectSpread2 = {}, (0, _defineProperty2["default"])(_objectSpread2, (0, _APIConfig.get)('REQUEST_FIELD_current'), current), (0, _defineProperty2["default"])(_objectSpread2, (0, _APIConfig.get)('REQUEST_FIELD_pageSize'), pageSize), _objectSpread2))
      });
    });
  }
