...
function useBaseList(_ref, config) {
  ...
  var loading = modelStatus.load.effects['fetchList'] || false;
  ...
  function onGetList(_ref2) {
    ...
    var payload = _objectSpread({}, qD, {}, queryData, (_objectSpread2 = {}, (0, _defineProperty2["default"])(_objectSpread2, (0, _APIConfig.get)('REQUEST_FIELD_current'), current), (0, _defineProperty2["default"])(_objectSpread2, (0, _APIConfig.get)('REQUEST_FIELD_pageSize'), pageSize), _objectSpread2));
