...
var _replaceKey = _interopRequireDefault(require("../../utils/replaceKey"));
...
function useBaseList(_ref, config) {
  ...
  function onDelete(_ref3) {
    ...
    dataPool.setRecord(record); // const api = formatAPI.deleteAPI;

    var a = (0, _replaceKey["default"])({
      modelStatus: modelStatus,
      dataPool: dataPool
    });
    var api = a.format(API.deleteAPI);
