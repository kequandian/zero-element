...
function useBaseChildren(_ref, config) {
  ...
  function onCreate(data) {
    ...
    dispatch({
      type: 'save',
      payload: (0, _objectSpread4["default"])({}, modelStatus)
    });
  }
  ...
  function onDelete(_ref3) {
    ...
    dispatch({
      type: 'save',
      payload: (0, _objectSpread4["default"])({}, modelStatus, (0, _defineProperty2["default"])({}, modelPath, (0, _objectSpread4["default"])({}, formData, (0, _defineProperty2["default"])({}, itemsPath, itemsData.filter(function (item) {
