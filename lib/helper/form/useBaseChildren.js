...
function useBaseChildren(_ref, config) {
  ...
  function onCreate(data) {
    ...
    itemsData.push(_objectSpread({}, data, {
      '_id': idRef.current++
    }));
    dispatch({
      type: 'save',
      payload: (0, _defineProperty2["default"])({}, modelPath, _objectSpread({}, formData, (0, _defineProperty2["default"])({}, itemsPath, itemsData)))
    });
  }
  /**
   * 添加多个子项
  ...
  function onRemoveChild(_ref3) {
    ...
    var temp = itemsData.filter(function (item) {
    ...
    dispatch({
      type: 'save',
      payload: (0, _defineProperty2["default"])({}, modelPath, _objectSpread({}, formData, (0, _defineProperty2["default"])({}, itemsPath, temp)))
    });
  }
