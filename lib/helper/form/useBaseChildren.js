...
function useBaseChildren(_ref, config) {
  ...
  function onCreate(data) {
    itemsData.push((0, _objectSpread3["default"])({}, data, {
      '_id': idRef.current++
    }));
    dispatch({
      type: 'save',
      payload: (0, _objectSpread3["default"])({}, modelStatus, (0, _defineProperty2["default"])({}, modelPath, (0, _defineProperty2["default"])({}, itemsPath, itemsData)))
    });
  }
  ...
  function onRemoveChild(_ref3) {
    ...
    dispatch({
      ...
      payload: {
        key: modelPath,
        data: (0, _defineProperty2["default"])({}, itemsPath, temp)
      }
    });
  }
