...
var _global = _interopRequireDefault(require("../config/global"));
...
function Reader(props) {
  ...
  var hooks = restProps.hooks;
  var zeleRef = (0, _react.useRef)(null);
  (0, _Model.setRef)(namespace, zeleRef);
  ...
  var _useState = (0, _react.useState)(function (_) {
    ...
    var pathname = (0, _location.getLocationPathname)();
    var searchData = (0, _location.getLocationSearch)();
  ...
  if (hooks) {
    (0, _Model.setHooks)(namespace, hooks);
  }

  return /*#__PURE__*/_react["default"].createElement("div", {
    ref: zeleRef
  }, /*#__PURE__*/_react["default"].createElement(_readConfig.UseLayout, (0, _extends2["default"])({
    n: canConfig.layout,
    title: canConfig.title,
    namespace: namespace
  }, canConfig.config || {}), canConfig.items && canConfig.items.map(function (itemCfg, i) {
    return /*#__PURE__*/_react["default"].createElement(_readConfig.UseItem, (0, _extends2["default"])({
      key: i,
      config: itemCfg,
